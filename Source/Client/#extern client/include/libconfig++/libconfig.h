...
extern  void config_set_default_format(config_t *config,
                                                    short format);

extern  void config_set_auto_convert(config_t *config, int flag);
extern  int config_get_auto_convert(const config_t *config);

extern  int config_read_string(config_t *config, const char *str);

extern  int config_read_file(config_t *config,
                                          const char *filename);
extern  int config_write_file(config_t *config,
                                           const char *filename);

extern  void config_set_destructor(config_t *config,
                                                void (*destructor)(void *));
extern  void config_set_include_dir(config_t *config,
                                                 const char *include_dir);
...
extern  int config_setting_set_int(config_setting_t *setting,
                                                int value);
extern  int config_setting_set_int64(config_setting_t *setting,
                                                  long long value);
extern  int config_setting_set_float(config_setting_t *setting,
                                                  double value);
extern  int config_setting_set_bool(config_setting_t *setting,
                                                 int value);
extern  int config_setting_set_string(config_setting_t *setting,
                                                   const char *value);

extern  int config_setting_set_format(config_setting_t *setting,
                                                   short format);
...
extern  config_setting_t *config_setting_set_int_elem(
  config_setting_t *setting, int idx, int value);
extern  config_setting_t *config_setting_set_int64_elem(
  config_setting_t *setting, int idx, long long value);
extern  config_setting_t *config_setting_set_float_elem(
  config_setting_t *setting, int idx, double value);
extern  config_setting_t *config_setting_set_bool_elem(
  config_setting_t *setting, int idx, int value);
extern  config_setting_t *config_setting_set_string_elem(
...
extern  int config_setting_index(const config_setting_t *setting);
...
extern  config_setting_t *config_setting_add(
  config_setting_t *parent, const char *name, int type);
extern  int config_setting_remove(config_setting_t *parent,
                                               const char *name);
extern  int config_setting_remove_elem(config_setting_t *parent,
                                                    unsigned int idx);
extern  void config_setting_set_hook(config_setting_t *setting,
                                                  void *hook);
...
extern  config_setting_t *config_lookup(const config_t *config,
                                                     const char *path);
extern  config_setting_t *config_lookup_from(
  config_setting_t *setting, const char *path);

extern  int config_lookup_int(const config_t *config,
                                           const char *path, int *value);
extern  int config_lookup_int64(const config_t *config,
                                             const char *path,
                                             long long *value);
extern  int config_lookup_float(const config_t *config,
                                             const char *path, double *value);
extern  int config_lookup_bool(const config_t *config,
                                            const char *path, int *value);
extern  int config_lookup_string(const config_t *config,
                                              const char *path,
                                              const char **value);
